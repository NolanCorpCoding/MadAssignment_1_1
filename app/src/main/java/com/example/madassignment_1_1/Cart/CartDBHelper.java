...
public class CartDBHelper extends SQLiteOpenHelper
{
    ...
    {
        sqLiteDatabase.execSQL("create table "+ CartDBSchema.CartTable.NAME+"("+ CartDBSchema.CartTable.Cols.ID+" INT, "+ CartDBSchema.CartTable.Cols.PRICE+" REAL,  "+ CartDBSchema.CartTable.Cols.USERACCOUNTID+ " TEXT, " + CartDBSchema.CartTable.Cols.ORDERTIME + " TEXT);");
    }
